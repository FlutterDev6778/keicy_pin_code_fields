            ...
            AbsorbPointer(
              ...
              child: AutofillGroup(
                child: TextFormField(
                  ...
                  autofillHints: widget.enablePinAutofill ? <String>[AutofillHints.oneTimeCode] : null,
        ...
        AnimatedContainer(
          ...
          child: Center(
            child: AnimatedSwitcher(
              ...
              child: Text(
                widget.obscureText && _inputList[i].isNotEmpty ? widget.obscuringCharacter : _inputList[i],
